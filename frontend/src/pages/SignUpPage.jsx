...
import { Mail, MessageSquare, User as UserIcon, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="input input-bordered w-full pl-10 border-gray-300 focus:ring-primary focus:border-primary rounded-lg"
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input input-bordered w-full pl-10 pr-10 border-gray-300 focus:ring-primary focus:border-primary rounded-lg"
                  placeholder=""
